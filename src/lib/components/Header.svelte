...
>
	<div class="navbar-start">
		<a href="/" class="btn btn-ghost text-primary text-xl">KeepRenderAlive</a>
	</div>

	<div class="navbar-end">
		<a
			href="https://github.com/AnishSarkar22/KeepRenderAlive"
			target="_blank"
		...
		<div class="dropdown dropdown-end">
			...
			<ul class="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow">
				...
				<li>
					<a href="/logout" class="text-error hover:text-error hover:bg-error/20">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							class="h-5 w-5"
							fill="none"
