    ...
    async function loadWebhook() {
        ...
        try {
            ...
            if (webhook) {
                ...
                scheduledTime = webhook.scheduledTime ? new Date(webhook.scheduledTime).toISOString().slice(0, 16) : '';
...
<div class="container mx-auto max-w-4xl px-4 py-8">
    <!-- Back Navigation -->
    <div class="mb-6">
        <a href="/webhooks" class="btn btn-ghost btn-sm">
            <svg
            ...
            <div class="card-body">
                ...
                <form onsubmit={handleSubmit} class="space-y-6">
                    ...
                    <div class="form-control">
                        <label class="label" for="priority-input">
                            <span class="label-text font-medium">Priority (1-10)</span>
                        </label>
                        <input
                            id="priority-input"
                            type="number"
                ...
                {#if webhook.status !== 'pending'}
                    <div class="alert alert-info mt-6">
                        ...
                        <span>
                            This webhook is {webhook.status} and cannot be edited. Only pending webhooks can be modified.
                        </span>
                    </div>
                {/if}
            </div>
